...
export default function Vizualization({ initialData, url }) {
  ...
  const [adminPassword] = useState(crypto.randomBytes(8).toString("hex"));
  ...
  return (
    <>
      ...
      <div className="z-0 w-full">
        ...
        <ToastContainer />
        <div>
          <a href="/home" className="ml-6 mt-2 mb-0 underline flex space-x-2">
            <AiOutlineHome fontSize="1.3rem" /> <p>Home</p>
          </a>
