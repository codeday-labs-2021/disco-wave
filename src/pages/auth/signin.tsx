    ...
    <div className="flex md:items-center justify-center h-screen">
      <div className="md:shadow-lg md:rounded-xl md:hover:shadow-2xl md:transition md:ease-in-out md:flex">
        ...
        <div className="py-6 space-y-6 px-6">
          ...
          <p className="text-gray-100 border-t border-gray-200 pt-6">
          ...
          >
            <FaSpotify fontSize="2rem" className="bg-transparent"/>
            <span className="text-lg md:text-xl bg-transparent">Sign in with Spotify</span>
          </button>
        </div>
      </div>
    </div>
